<!-- Contributor Onboarding Page: _pages/contributors.md -->
---
layout: page
...
<section>
  ...
  <ul>
    <li><strong>Step 1:</strong> <a class="button" href="https://github.com/rjhinrichs/aimoralcode/issues/new?template=blog-contributor-request.yml" target="_blank">Request Contributor Access</a></li>
    <li><strong>Step 2:</strong> <a class="button" href="https://github.com/rjhinrichs/aimoralcode/issues/new?template=new-blogpost.yml" target="_blank">Submit a Blog Post</a></li>
